        ...
        return tf.train.Example(
            features=tf.train.Features(
                feature={
                    ...
                    'image/object/bbox/xmin': dataset_util.float_list_feature([b.xmin/img.width for b in bounding_boxes]),
                    'image/object/bbox/xmax': dataset_util.float_list_feature([b.xmax/img.width for b in bounding_boxes]),
                    'image/object/bbox/ymin': dataset_util.float_list_feature([b.ymin/img.height for b in bounding_boxes]),
                    'image/object/bbox/ymax': dataset_util.float_list_feature([b.ymax/img.height for b in bounding_boxes]),
